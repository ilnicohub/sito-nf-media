    ...
    <div className={styles.main}>
      ...
      <motion.section className={styles.content} {...fadeIn}>
        <div className={styles.container}>
          ...
          <p>
            NF MEDIA LAB (di seguito "il Titolare"), nella persona di Fabrin Niccolò con P.IVA 05640760269, con sede in Via Casoni, 28 Vedelago (TV), è responsabile del trattamento dei tuoi dati personali.
          </p>
